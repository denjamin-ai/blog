...
## TC-G-GUIDE-001: Открытие руководства гостя
...
### Test Steps
1. На главной странице или `/blog` найти ссылку/кнопку «Руководство» (если доступна гостям)
   **Expected:** Страница или модальное окно с руководством открывается; контент описывает возможности платформы для неавторизованных пользователей (чтение, RSS, профили авторов)
